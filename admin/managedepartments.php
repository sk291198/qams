...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Manage Quarters</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: green;">Manage Quarters</div>
                    </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: red;">Quarters Block</th>
                                            <th style="color: red;">Quarters Name</th>
