...
$sql = "SELECT EmpId,FirstName,LastName,Emailid,Password,id from  tblemployees where empid=tblemployees.empid";
$query = $dbh -> prepare($sql);
$query->execute();
...
$message ="
  ...
  Employee Registration successfully done...
 ";
}
}
...
<div class="input-field col m6 s12">
<input id="birthdate" name="dob" type="date" placeholder="DOB" max="2000-01-01" class="form-control" autocomplete="off" >
</div>
