...
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblleaves.QutName,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
...
{         
  ...
  <tr>
                                             <td style="font-size:16px;"><b>Quarters Name :</b></td>
                                            <td><?php echo htmlentities($result->QutName);?></td>
                                             <td style="font-size:16px;"><b>Emp Living Dates :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Employee Reason : </b></td>
...
$message= "         
  ...
  Quarters Name: $result->QutName
            ...
            YOUR SUBMITTED REQUEST ACCEPTED SUCCESSFULLY...
...
mail($toemail,"Employee Request Accepted",$message,$headers);
...
$message= "         
  ...
  Quarters Name: $result->QutName
            ...
            YOUR SUBMITTED REQUEST REJECTED...

   Reasons:
            Due to Allotment of Quarters to Other Employee...
            OR submitted documents were incorrect...
            Please consult the department...
...
$headers ='From: <nickholous@gmail.com>';
mail($toemail,"Employee Request Rejected",$message,$headers);
